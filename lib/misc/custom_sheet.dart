...
const Duration _kBottomSheetDuration = Duration(milliseconds: 300);
...
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showModalBottomSheetCustom].
///
/// See also:
///
///  * [showBottomSheetCustom] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showModalBottomSheetCustom], which can be used to display a modal bottom
///    sheet.
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showModalBottomSheetCustom], for modal bottom sheets.
  const BottomSheet(
      {Key key,
...
class _ModalBottomSheetState<T> extends State<_ModalBottomSheet<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        child: BottomSheet(
          animationController: widget.route._controller,
            ...
            child: ClipRect(
              child: CustomSingleChildLayout(
                ...
                child: FadeTransition(
                    opacity: widget.route.animation, child: child),
              ),
            ),
          );
        });
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  AnimationController createAnimationController() {
    ...
    _controller = BottomSheet.createAnimationController(navigator.overlay);
    return _controller;
  }
...
/// can be created and displayed with the [showBottomSheetCustom] function or the
...
/// [showModalBottomSheetCustom] function.
///
